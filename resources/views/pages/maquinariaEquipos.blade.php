        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <h2 class="parallax-title2">Maquinarias y Equipos<span>Aquiler para la construcción</span></h2>
	...
	<div class="row sticky-wrapper">
		...
		<div class="col-md-3">
			<ul class="services-list sticky">
				...
				<li><a href="{{route('maquinariaEquipos_path')}}" class="{{ Request::is('servicios/maquinaria-equipos-construccion') ? "active" : "" }}">Maquinaria y Equipos</a></li>
