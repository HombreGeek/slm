...
@section('title', ' | Venta de Acero Figurado')
...
@section('content')
  ...
  <!-- Parallax Banner
    ================================================== -->
    <div class="parallax-banner margin-bottom-20" style="background-image: url({{asset('img/acero-figurado.jpg')}})">
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
		...
		<div class="col-md-9 col-sm-12 extra-gutter-left">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<a href="{{asset('img/acero-figurado-servicio.jpg')}}" class="img-hover mfp-gallery margin-bottom-10"><img src="{{asset('img/acero-figurado-servicio.jpg')}}" alt="" /></a>
				...
				<div class="col-md-6">
					<a href="{{asset('img/acero-figurado-servicio02.jpg')}}" class="img-hover mfp-gallery margin-bottom-10"><img src="{{asset('img/acero-figurado-servicio02.jpg')}}" alt="" /></a>
